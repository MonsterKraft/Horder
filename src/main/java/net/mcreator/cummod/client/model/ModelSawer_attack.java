...
public class ModelSawer_attack<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cummod", "model_sawer_attack"), "main");
	public final ModelPart saw2;
	public final ModelPart leg2;
	public final ModelPart arm2;
	public final ModelPart body;
	public final ModelPart eye;
	public final ModelPart saw3;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = saw2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 74).addBox(-7.0F, -7.0F, 0.0F, 14.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
		PartDefinition cube_r2 = saw2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -5.0F, -1.0F, 10.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2",
				CubeListBuilder.create().texOffs(58, 40).addBox(-7.0F, -3.0F, -8.0F, 9.0F, 18.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						.addBox(2.0F, 12.0F, -7.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(38, 40).addBox(2.0F, -2.0F, -7.0F, 1.0F,
		...
		PartDefinition arm2 = partdefinition.addOrReplaceChild("arm2",
				CubeListBuilder.create().texOffs(46, 0).addBox(-5.0F, -5.0F, -10.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(70, 20)
		...
		PartDefinition saw3 = partdefinition.addOrReplaceChild("saw3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(14.5F, -1.1F, -26.95F, -1.2538F, 1.3367F, -1.1125F));
		PartDefinition cube_r5 = saw3
				.addOrReplaceChild(
						"cube_r5", CubeListBuilder.create().texOffs(0, 74).mirror()
								.addBox(-7.0F, -7.0F, 0.0F, 14.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.7854F));
		PartDefinition cube_r6 = saw3
				.addOrReplaceChild(
		...
		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(58, 40).mirror().addBox(-2.0F, -3.0F, -8.0F, 9.0F, 18.0F, 8.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 12).mirror().addBox(-3.0F, 12.0F, -7.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(38, 40).mirror().addBox(-3.0F, -2.0F, -7.0F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.0F, 9.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition arm3 = partdefinition.addOrReplaceChild("arm3",
				CubeListBuilder.create().texOffs(46, 0).mirror().addBox(-7.2052F, -3.8859F, -8.7649F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(70, 20).mirror().addBox(-5.2052F, 6.1141F, -7.7649F, 6.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(28, 74).mirror().addBox(-1.2052F, 15.1141F, -5.7649F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(18, 12).mirror().addBox(-4.2052F, 15.1141F, -5.7649F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(52, 47).mirror().addBox(-1.2052F, 15.1141F, -2.7649F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(14, 12).mirror().addBox(-4.2052F, 15.1141F, -2.7649F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(38, 53).mirror().addBox(-5.2052F, 26.1141F, -5.7649F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(52, 40).mirror().addBox(-5.2052F, 26.1141F, -2.7649F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false),
