...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Skin2 = Head.addOrReplaceChild("Skin2", CubeListBuilder.create(), PartPose.offset(1.4936F, -7.0071F, -3.6589F));
		PartDefinition cube_r1 = Skin2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(23, 0).addBox(0.5F, -3.0F, -11.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(23, 20)
						...
						.addBox(4.0F, 0.0F, -5.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(71, 66).addBox(5.0F, -5.0F, -10.0F, 1.0F,
								6.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4936F, 0.5071F, 0.7339F, 0.0F, -0.48F, 0.0F));
		PartDefinition cube_r2 = Skin2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(12, 50).addBox(-1.25F, -1.25F, 0.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Skin2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(52, 65).addBox(0.45F, -3.9F, 0.25F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.4993F, 7.2071F, -2.9538F, -0.2605F, -0.5044F, -0.0951F));
		...
		PartDefinition Scull = Head.addOrReplaceChild("Scull",
				CubeListBuilder.create().texOffs(0, 76).addBox(-3.5F, -7.9727F, -5.226F, 7.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(90, 0)
		...
		PartDefinition cube_r7 = Scull.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.75F, -3.4727F, -7.726F, 0.0F, 0.0F, -0.1745F));
		PartDefinition cube_r8 = Scull.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(14, 15).addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.75F, -3.4727F, -7.726F, 0.0F, 0.0F, 0.1745F));
		...
		PartDefinition cube_r15 = Scull.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 50).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Skin = Head.addOrReplaceChild("Skin", CubeListBuilder.create(), PartPose.offset(-1.4936F, -7.0071F, -3.6589F));
		PartDefinition cube_r17 = Skin.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(28, 7).addBox(-1.5F, -3.0F, -11.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 10)
						...
						.addBox(-5.0F, 0.0F, -5.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(75, 41).addBox(-6.0F, -5.0F, -10.0F, 1.0F,
								6.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.4936F, 0.5071F, 0.7339F, 0.0F, 0.48F, 0.0F));
		PartDefinition cube_r18 = Skin.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(23, 65).addBox(-2.75F, -1.25F, 0.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.5722F, 0.5071F, -7.4254F, 0.5672F, 0.48F, 0.0F));
		...
		PartDefinition cube_r20 = Skin.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(71, 0).addBox(-1.45F, -3.9F, 0.25F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.4993F, 7.2071F, -2.9538F, -0.2605F, 0.5044F, 0.0951F));
		PartDefinition cube_r21 = Skin.addOrReplaceChild("cube_r21",
				...
				PartPose.offsetAndRotation(-4.0188F, -1.9929F, 2.628F, 0.0F, 2.2689F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create(), PartPose.offset(0.0F, 4.0F, 8.0F));
		PartDefinition cube_r22 = Body.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -5.0F, -2.5F, 9.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -14.0F, 0.5F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r23 = Body.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(0, 65).addBox(-4.5F, -1.0F, -2.5F, 9.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.5F, 1.5F, -1.5708F, 0.0F, 0.0F));
		PartDefinition cube_r24 = Body.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(28, 65).addBox(-3.5F, -5.0F, -2.5F, 7.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 0.5F, -0.2618F, 0.0F, 0.0F));
		PartDefinition L_L = partdefinition.addOrReplaceChild("L_L", CubeListBuilder.create(), PartPose.offset(6.0F, 3.5F, 9.5F));
		PartDefinition cube_r25 = L_L.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(23, 35).addBox(4.5F, -3.0F, -2.5F, 4.0F, 6.0F, 15.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, 0.0F, -2.0F, -2.0071F, 0.0F, 0.0F));
		PartDefinition cube_r26 = L_L.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(86, 36).addBox(-3.0F, 4.0F, 0.0F, 6.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 15)
						.addBox(-2.0F, -2.0F, -1.0F, 4.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 18.4546F, -4.9389F, -1.5708F, 0.0F, 0.0F));
		PartDefinition cube_r27 = L_L.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(71, 23).addBox(-1.0F, -3.6954F, -0.4277F, 2.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 11.0F, -9.0F, -1.6581F, 0.0F, 0.0F));
		PartDefinition R_L = partdefinition.addOrReplaceChild("R_L", CubeListBuilder.create(), PartPose.offset(-6.5F, 3.6171F, 7.5887F));
		PartDefinition cube_r28 = R_L.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(0, 20).addBox(-8.5F, -3.0F, -2.5F, 4.0F, 6.0F, 15.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.5F, -0.1171F, -0.0887F, -2.0071F, 0.0F, 0.0F));
		PartDefinition cube_r29 = R_L.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(0, 88).addBox(-3.0F, 4.0F, 0.0F, 6.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 83)
						.addBox(-2.0F, -2.0F, -1.0F, 4.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.3375F, -3.0276F, -1.5708F, 0.0F, 0.0F));
		PartDefinition cube_r30 = R_L.addOrReplaceChild("cube_r30",
				...
				PartPose.offsetAndRotation(0.0F, 10.8829F, -7.0887F, -1.6581F, 0.0F, 0.0F));
		PartDefinition L_A = partdefinition.addOrReplaceChild("L_A", CubeListBuilder.create(), PartPose.offset(4.0F, -12.5F, 9.5F));
		PartDefinition cube_r31 = L_A.addOrReplaceChild("cube_r31",
				...
				PartPose.offsetAndRotation(1.0658F, -0.3205F, -1.4987F, 0.3899F, -0.6455F, 0.4508F));
		PartDefinition R_A = partdefinition.addOrReplaceChild("R_A", CubeListBuilder.create(), PartPose.offset(-4.0F, -12.5F, 9.5F));
