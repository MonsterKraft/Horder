...
public class Modelblader_idle<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition L_L = partdefinition.addOrReplaceChild("L_L", CubeListBuilder.create(), PartPose.offset(6.0F, 2.5F, 9.5F));
		...
		PartDefinition R_L = partdefinition.addOrReplaceChild("R_L", CubeListBuilder.create(), PartPose.offset(-6.5F, 3.0363F, 7.3358F));
