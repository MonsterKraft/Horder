...
public class ModelBlader_idle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cummod", "model_blader_idle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r19 = Head.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(68, 8).addBox(-2.5F, -1.0F, -3.0F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = Head.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(70, 70).addBox(-2.5F, -1.0F, -3.0F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = da.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(85, 68).addBox(-1.5F, -1.5F, -1.75F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 9)
						.addBox(0.0F, -2.5F, -2.5F, 0.0F, 21.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(78, 45).addBox(-1.0F, 0.5F, -1.5F, 2.0F,
		...
		PartDefinition cube_r39 = dl.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(16, 39).addBox(-0.5F, -4.0154F, -3.8478F, 0.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(6, 84)
		...
		PartDefinition cube_r52 = Left_Arm.addOrReplaceChild("cube_r52",
				CubeListBuilder.create().texOffs(66, 13).addBox(-6.5F, -4.0F, 0.0F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5315F, -1.0146F, -1.1918F, 0.3099F, 0.1664F, 0.053F));
		...
		PartDefinition cube_r57 = da2.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(25, 0).addBox(-1.5F, -1.5F, -1.75F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 9)
						.addBox(0.0F, -2.5F, -2.5F, 0.0F, 21.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 76).addBox(-1.0F, 0.5F, -1.5F, 2.0F,
								9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.2966F, 1.3679F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r67 = dl2.addOrReplaceChild("cube_r67",
				CubeListBuilder.create().texOffs(16, 32).addBox(0.5F, -4.0154F, -3.8478F, 0.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(82, 0)
						.addBox(-1.5F, -2.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.375F, -0.2981F, -1.0534F, -0.48F, 0.0F, 0.0F));
