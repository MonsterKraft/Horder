...
public class ModelSawer_idle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sawer_idle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arm = partdefinition.addOrReplaceChild("arm",
				CubeListBuilder.create().texOffs(46, 0)
						.addBox(-3.0F, -5.0F, 0.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(70, 20)
						...
						.addBox(-1.0F, 25.0F, 6.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 40)
						.addBox(-1.0F, 25.0F, 3.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(12.0F, -14.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition saw = arm.addOrReplaceChild("saw", CubeListBuilder.create(),
		...
		PartDefinition leg = partdefinition.addOrReplaceChild("leg",
				CubeListBuilder.create().texOffs(58, 40)
						.addBox(-6.9651F, -2.0F, 0.0003F, 9.0F, 18.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(58, 40).mirror()
				.addBox(-2.0349F, -2.0F, 0.0003F, 9.0F, 18.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 12).mirror().addBox(-3.0349F, 13.0F, 1.0003F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(38, 40).mirror()
				.addBox(-3.0349F, -1.0F, 1.0003F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.0F, 8.0F, 0.0F, -3.1416F, -1.5533F, -3.1416F));

		PartDefinition arm2 = partdefinition.addOrReplaceChild("arm2", CubeListBuilder.create().texOffs(46, 0).mirror()
				.addBox(-7.0F, -5.0F, 0.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(70, 20).mirror().addBox(-5.0F, 5.0F, 1.0F, 6.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(28, 74).mirror()
				.addBox(-1.0F, 14.0F, 6.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(18, 12)
				.mirror().addBox(-4.0F, 14.0F, 6.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(52, 47).mirror().addBox(-1.0F, 14.0F, 3.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(14, 12).mirror()
				.addBox(-4.0F, 14.0F, 3.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(38, 53)
				.mirror().addBox(-5.0F, 25.0F, 6.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(52, 40).mirror().addBox(-5.0F, 25.0F, 3.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false), PartPose.offsetAndRotation(-12.0F, -14.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition saw2 = arm2.addOrReplaceChild("saw2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 18.0F, -12.0F));

		PartDefinition cube_r4 = saw2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 74).mirror()
				.addBox(-7.0F, -7.0F, 0.0F, 14.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 0)
				.mirror().addBox(-5.0F, -5.0F, -1.0F, 10.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.0F, 10.0F, 17.0F, 0.0F, 0.0F, -0.7854F));
