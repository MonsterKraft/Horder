...
public class Modelblader_attack<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = Skin2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(52, 65).addBox(-0.883F, -4.6163F, -1.3962F, 1.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = Scull.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(93, 26).addBox(-0.5F, -2.0F, -2.0F, 1.0F, 6.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0273F, -8.226F, 0.0F, -0.48F, 0.0F));

		PartDefinition cube_r11 = Scull.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(38, 93).addBox(-0.5F, -2.0F, -2.0F, 1.0F, 6.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 0.0273F, -8.226F, 0.0F, 0.48F, 0.0F));
		...
		PartDefinition cube_r20 = Skin.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(71, 0).addBox(-0.2958F, -5.5238F, -1.993F, 1.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
